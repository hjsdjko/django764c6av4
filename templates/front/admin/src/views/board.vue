<template>
	<div class="content" :style='{"alignContent":"flex-start","overflow":"hidden","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231223/2592f2b1d33d45d299f892501055ed24.jpg) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"100vh"}'>
		...
		<div :style='{"width":"100%","flexWrap":"wrap","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"100%","margin":"0 0 40px 0","display":"flex","height":"100px"}'>
				<div :style='{"width":"25%","flexWrap":"wrap","display":"flex"}'>
				</div>
				<div :style='{"width":"50%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
					<!-- 统计 -->
					<div :style='{"padding":"0","margin":"0","color":"#fff","alignItems":"center","display":"flex","justifyContent":"center","alignContent":"center","flexWrap":"wrap","background":"none","width":"100%","fontSize":"14px","height":"100px","order":"1"}'>

						<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","flexDirection":"column","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
							...
							<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
								<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>电影数据总数</div>
								<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{dianyingshujuCount}}</div>
							</div>
						</div>

						<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
							<div :style='{"width":"32px","background":"yellow","display":"none","height":"32px"}'></div>
							<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
								<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>电影数据2总数</div>
								<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{dianyingshujuerCount}}</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div :style='{"width":"100%","padding":"0 40px","alignItems":"center","flexWrap":"wrap","display":"flex","height":"calc(100vh - 235px)"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="dianyingshujuChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="dianyingshujuChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="dianyingshujuChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="dianyingshujuChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="dianyingshujuChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts6">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="dianyingshujuerChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts7">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="dianyingshujuerChart7" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts8">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="dianyingshujuerChart8" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
export default {
	data() {
		return {
			...
			boardDataList: [],
			dates: '',
            dianyingshujuCount: 0,
            dianyingshujuerCount: 0,
  ...
  created() {
    this.$nextTick(()=>{
		this.times()
		setTimeout(()=>{
			this.getdianyingshujuCount();
			this.dianyingshujuChat1();
			this.dianyingshujuChat2();
			this.dianyingshujuChat3();
			this.dianyingshujuChat4();
			this.dianyingshujuChat5();
			this.getdianyingshujuerCount();
			this.dianyingshujuerChat6();
			this.dianyingshujuerChat7();
			this.dianyingshujuerChat8();
		},500)
	})
  },
  methods:{
    ...
    getdianyingshujuCount() {
        this.$http({
            url: `dianyingshuju/count`,
            method: "get"
        }).then(({
            data
        }) => {
            if (data && data.code == 0) {
                this.dianyingshujuCount = data.data
            }
        })
    },
...
//统计接口1
    dianyingshujuChat1() {
      this.$nextTick(()=>{
        ...
        this.$http({
            url: "group/dianyingshuju/dianyingmingcheng",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    xAxis.push(res[i].dianyingmingcheng);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].dianyingmingcheng
                    })
                }
                var option = {};
                this.wordclouds(pArray,'dianyingshujuChart1');
...
//统计接口2
    dianyingshujuChat2() {
      this.$nextTick(()=>{
        ...
        var dianyingshujuChart2 = echarts.init(document.getElementById("dianyingshujuChart2"),'macarons');
        this.$http({
            url: "dianyingshuju/group/zhuyan",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                dianyingshujuChart2.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    dianyingshujuChart2.resize();
                },false);
            }
        });
      })
...
//统计接口3
    dianyingshujuChat3() {
      this.$nextTick(()=>{
        ...
        var dianyingshujuChart3 = echarts.init(document.getElementById("dianyingshujuChart3"),'macarons');
        this.$http({
            url: "dianyingshuju/group/dianyingpingfen",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].dianyingpingfen);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].dianyingpingfen
                    })
                }
                var option = {};
                ...
                // 使用刚指定的配置项和数据显示图表。
                dianyingshujuChart3.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    dianyingshujuChart3.resize();
                },false);
            }
        });
      })
...
//统计接口4
    dianyingshujuChat4() {
      this.$nextTick(()=>{
        ...
        var dianyingshujuChart4 = echarts.init(document.getElementById("dianyingshujuChart4"),'macarons');
        this.$http({
            url: "dianyingshuju/group/daoyan",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                dianyingshujuChart4.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    dianyingshujuChart4.resize();
				},false);
            }
        });
      })
...
//统计接口5
    dianyingshujuChat5() {
      this.$nextTick(()=>{
        ...
        var dianyingshujuChart5 = echarts.init(document.getElementById("dianyingshujuChart5"),'macarons');
        this.$http({
            url: "dianyingshuju/group/leixing",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                dianyingshujuChart5.setOption(option);


                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    dianyingshujuChart5.resize();
					},false);
            }
        });
      })
    },
    getdianyingshujuerCount() {
        this.$http({
            url: `dianyingshujuer/count`,
            method: "get"
        }).then(({
            data
        }) => {
            if (data && data.code == 0) {
                this.dianyingshujuerCount = data.data
            }
        })
    },

//统计接口1
    dianyingshujuerChat6() {
      this.$nextTick(()=>{

        var dianyingshujuerChart6 = echarts.init(document.getElementById("dianyingshujuerChart6"),'macarons');
        this.$http({
            url: "dianyingshujuer/group/chandi",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                dianyingshujuerChart6.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    dianyingshujuerChart6.resize();
                },false);
            }
        });
      })
...
//统计接口2
    dianyingshujuerChat7() {
      this.$nextTick(()=>{

        var dianyingshujuerChart7 = echarts.init(document.getElementById("dianyingshujuerChart7"),'macarons');
        this.$http({
            url: "dianyingshujuer/group/yuyan",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                dianyingshujuerChart7.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    dianyingshujuerChart7.resize();
                },false);
            }
        });
      })
...
//统计接口3
    dianyingshujuerChat8() {
      this.$nextTick(()=>{

        var dianyingshujuerChart8 = echarts.init(document.getElementById("dianyingshujuerChart8"),'macarons');
        this.$http({
            url: "dianyingshujuer/group/dianyingshizhang",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].dianyingshizhang);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].dianyingshizhang
                    })
                }
                var option = {};
				let titleObj = this.bar.title
                ...
                // 使用刚指定的配置项和数据显示图表。
                dianyingshujuerChart8.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    dianyingshujuerChart8.resize();
                },false);
            }
        });
      })
